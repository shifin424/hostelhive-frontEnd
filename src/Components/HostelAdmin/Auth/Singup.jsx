...
function Singnup() {
  ...
  return (
    <div>
     <div className="w-full min-h-screen bg-white mx-auto px-4 sm:px-6 lg:px-8 py-20">
  <Formik
  ...
  >
    <Form className="max-w-2xl bg-[#93b8f9] mx-auto mt-8 rounded-md shadow-2xl p-6">
      ...
      <div className="text-center mt-8">
        <button
          type="submit"
          className="bg-[#1a4ca3] text-white text-lg hover:bg-blue-500 px-16 py-4 rounded-full"
        >
          Submit
        </button>
      </div>
  ...
  <p className="text-center mt-4">
    <button
      className="text-gray-500 font-bold font-popins text-center mt-4"
      onClick={() => goBack()}
    >
      Go back
    </button>
