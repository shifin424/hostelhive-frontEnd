              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <img src="https://randomuser.me/api/portraits/men/94.jpg" class="w-32 h-32 bg-[#ffffff] rounded-full mb-4 border border-[#002D74] p-2" alt="Profile" />
                  ...
                  <div className="mt-6 flex flex-wrap gap-4 justify-center">
                    <Link to={'/student/edit-profile'} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">Edit profile</Link>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-gray-900">987-654-3210</p>
                    </div>
