        ...
        <div>
            <div className="w-full h-screen bg-white mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                >
                    ...
                    <Form className="max-w-2xl bg-white mx-auto mt-8">
                    {error && (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <Field type="text" id="fullName" name="fullName" className="border rounded-md p-2 w-full" />
                            ...
                            <div>
                                ...
                                <Field type="password" id="password" name="password" className="border rounded-md p-2 w-full" />
                                <ErrorMessage name="password" component="div" className="text-red-500" />
                            </div>

                            <div>
                                <label htmlFor="confirmPassword">Confirm Password</label>
                                <Field type="password" id="confirmPassword" name="confirmPassword" className="border rounded-md p-2 w-full" />
                                <ErrorMessage name="confirmPassword" component="div" className="text-red-500" />
                            </div>

                            <div>
                                <label htmlFor="mobileNumber">Mobile Number</label>
                                <Field type="text" id="mobileNumber" name="mobileNumber" className="border rounded-md p-2 w-full" />
                                <ErrorMessage name="mobileNumber" component="div" className="text-red-500" />
                            </div>

                            <div>
                                <label htmlFor="qualification">Qualification</label>
                                <Field type="text" id="qualification" name="qualification" className="border rounded-md p-2 w-full" />
                            ...
                            <div>
                                ...
                                <Field as="select" id="gender" name="gender" className="border rounded-md p-2 w-full">
